...
function urlOnLineToBase() {
  urlToBase64("https://pure-admin-doc.vercel.app/img/pure.png").then((res) => {
...
<template>
  <naive-theme>
    ...
    <n-space className="flex items-center mb-2">
      ...
      <img :src="blob" alt="base64OnLineUrl" width="60" height="60" v-show="blob" />
    </n-space>
  </naive-theme>
</template>
